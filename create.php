...
<div class="spoiler">
    ...
    <div class="spoiler-content">
        ...
        <div>
            <i class="fa-solid fa-key"></i> Close with password: <br /><input type="text" name="password" maxlength="128" placeholder="pass"> 
        </div>
    </div>
</div>
...
if (!empty($text)) {
    $add_free_access = "INSERT INTO `content` (`id`, `name`, `link`, `author`, `text`, `date`, `pass`, `ip`, `del`, `hash`) VALUES (NULL, '" . $title . "', '" . $link . "', '" . $author     . "', '" . $text . "', '" . $file_data_texiti . "', '" . $pass . "', '" . $ch_access_ip . "', '" . $ch_delete . "', '". $hash . "')";
